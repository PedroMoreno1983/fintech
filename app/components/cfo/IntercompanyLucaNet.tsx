...
export default function IntercompanyLucaNet({
  ...
  // NUEVOS ESTADOS DE AUDITORÍA INTERCOMPANY
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-slate-100 animate-fade-in">
      ...
      <div className="lg:col-span-6 bg-slate-900/60 backdrop-blur-md p-6 rounded-3xl border border-slate-800 flex flex-col justify-between gap-6 shadow-xl">
              ...
              operacionesFiltradas.map((op) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Drill-down de Conciliación LucaNet detallada */}
                    {isSelected && !op.conciliada && (
                      <div className="mt-2.5 p-3 bg-slate-900/80 border border-amber-900/30 rounded-xl space-y-2.5 text-[11px] animate-fade-in">
                        ...
                        <div className="grid grid-cols-2 gap-4 border-y border-slate-800 py-2 font-mono">
                          <div className="space-y-1">
                            <div className="flex justify-between">
                              <span className="text-slate-500">Registrado Cuentas Cobrar:</span>
                          ...
                          <div className="space-y-1 border-l border-slate-800 pl-4">
                            <div className="flex justify-between">
                              <span className="text-slate-500">Registrado Cuentas Pagar:</span>
                              <span className="text-slate-300 font-bold">${(op.monto - (op.diferencia || 0)).toLocaleString("es-CL")}</span>
                            </div>
                            <div className="flex justify-between text-[10px]">
                              <span className="text-slate-500">Variación Descalce:</span>
                        ...
                        <div className="flex items-start gap-2 text-[10px] text-amber-300/90 bg-amber-950/20 p-2 rounded-lg border border-amber-900/30 leading-relaxed">
                          ...
                          <span><strong>Acción Correctiva LucaNet</strong>: Se generará un asiento automático de cuadre en la sociedad de consolidación para regularizar la diferencia de ${op.diferencia?.toLocaleString("es-CL")} CLP debida a devengos y diferencias cambiarias al cierre.</span>
                        </div>
                      </div>
                    )}
